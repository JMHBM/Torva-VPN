...
Quitting Torva is designed to restore those settings. You are responsible for returning your system to a working state if a crash or force-quit leaves routing changed.
